...
public:
	...
	static bool PostRFA::postRFAaction(									// 11/23/98 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAlittopair(
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFApair(
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAlittoaction(							// 11/23/98 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAactions(								// 11/23/98 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAregion(									// 11/24/98 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAregions(								// 11/24/98 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFArecurse(								// 11/25/98 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFArecurses(								// 11/25/98 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFArulesfile(								// 11/24/98 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFArange(									// 11/29/98 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFApres(									// 11/29/98 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAnodes(									// 11/30/98 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAselect(									// 11/30/98 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAcode(									// 12/07/98 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	...
	static bool PostRFA::postRFAlitelt(
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAnonlitelt(
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAelement(
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAelt(
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFArulelts(
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAsugg(
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFArule(
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFArules(
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	///////////////// NLP++ SEMANTICS
	static bool PostRFA::postRFAmovesem(								// 11/09/99 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAmakestmt(								// 05/11/00 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp,															// 11/19/99 AM.
		bool semicolon = true	// Semicolon at end.					// 05/29/01 AM.
		);
	static bool PostRFA::postRFAmakestmts(								// 05/29/01 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp
		);
	static bool PostRFA::postRFAaddstmt(								// 11/12/99 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAifstmt(									// 11/12/99 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAifelse(									// 11/12/99 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAexpr(									// 11/10/99 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAunary(									// 11/11/99 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFApostunary(								// 11/11/99 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAvar(										// 11/09/99 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	static bool PostRFA::postRFAop(										// 11/09/99 AM.
		Delt<Iarg> *args,
		Nlppp *nlppp															// 11/19/99 AM.
		);
	...
	static bool PostRFA::args_range(										// 01/17/99 AM.
		_TCHAR *action,				// Name of current postRFA action.
		Delt<Iarg> *args,			// Argument list for the action.
		Tree<Pn> *collect,		// Tracking for current rule match.
		Sem *sem,					// Semantic object built by actions, if any.
	...
	static bool PostRFA::args_0to4(										// 11/27/98 AM.
		_TCHAR *action,				// Name of current postRFA action.
		Delt<Iarg> *args,			// Argument list for the action.
		Tree<Pn> *collect,		// Tracking for current rule match.
		Sem *sem,					// Semantic object built by actions, if any.
	...
	/////////////////
	//static void PostRFA::fillDefaults(Ielt *elt);

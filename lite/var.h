...
public:
	...
	static bool Var::create(_TCHAR *name, Iarg *val, Parse *parse
		//, Seqn *seqn														// 01/14/00 AM.
		);
	static bool Var::createstrs(_TCHAR *name, Parse *parse
		//, Seqn *seqn														// 01/14/00 AM.
		);
	static bool Var::find(
		_TCHAR *name,					// Variable name to find.
	...
	static bool Var::addStrs(			// 01/24/99 AM.
		_TCHAR *name,			// Variable name.
		_TCHAR *str,			// String value to add.
		Parse *parse
		);
	static bool Var::setVal(_TCHAR *name, Parse *parse, _t_ostream *ostr);	//2/9/99AM
	...
	static bool Var::filevar(												// 12/31/99 AM.

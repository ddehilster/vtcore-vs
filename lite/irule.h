...
public:
	...
	Irule *Irule::copy_owning();	// 07/03/99 AM.
	...
	// General
	bool Irule::rhash(tHtab<Slist<Irule> > *htab,					// 12/16/98 AM.
								Parse*);											// 04/03/03 AM.
	bool Irule::unpack(														// 10/06/99 AM.
		/*UP*/
		Dlist<Ielt>* &phr,
		Isugg* &sgg,
		Delt<Ielt>* &trig
	...
	static Dlist<Irule> *Irule::makeDlist();	// Make empty list.
	...
	static void Irule::deleteOwning(Irule *rule);					// 07/03/99 AM.
	...
	static bool Irule::genRuleblocks(									// 11/04/99 AM.
		Dlist<Irule> *rules,
		_TCHAR *sep,			// Element separator.
		_t_ostream &ofile
		);
	static bool Irule::genRulerecurses(									// 11/04/99 AM.
		Dlist<Irule> *rules,
		_TCHAR *sep,			// Element separator.
		_t_ostream &ofile
		);
